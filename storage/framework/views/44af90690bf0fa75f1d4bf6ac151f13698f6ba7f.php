    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container py-8">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header with-border">
                    ...
                    <div class="card-title">
                        <div class="btn-group float-right" style="margin-right: 5px">
                            <a target=_new href="<?php echo e(sc_route_admin('admin_product.index')); ?>" class="btn  btn-flat btn-default" title="List">
                ...
                <!-- form start -->
                <form action="<?php echo e(sc_route_admin('admin_product.create')); ?>" method="post" name="form_name" accept-charset="UTF-8"
                      class="form-horizontal" id="form-main" enctype="multipart/form-data">
                    <input type="hidden" name="kind" value="<?php echo e(SC_PRODUCT_SINGLE); ?>">
                    ...
                    <div id="main-add" class="card-body">
                        ...
                        <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row kind  <?php echo e($errors->has('descriptions.'.$code.'.content') ? ' text-red' : ''); ?>">
                                ...
                                <textarea id="<?php echo e($code); ?>__content" class="editor"
                                    ...
                                    <div class="form-group row kind  <?php echo e($errors->has('descriptions.'.$code.'.specifications') ? ' text-red' : ''); ?>">
                                        <label for="<?php echo e($code); ?>__specifications" class="col-sm-2 col-form-label">
                                            Specifications
                                        </label>
                                        <div class="col-sm-8">
                                <textarea id="<?php echo e($code); ?>__specifications" class="editor"
                                          name="descriptions[<?php echo e($code); ?>][specifications]">
                                        <?php echo old('descriptions.'.$code.'.specifications'); ?>
                                    ...
                                    <div class="form-group row kind  <?php echo e($errors->has('descriptions.'.$code.'.condition') ? ' text-red' : ''); ?>">
                                        <label for="<?php echo e($code); ?>__condition" class="col-sm-2 col-form-label">
                                            Condition
                                        </label>
                                        <div class="col-sm-8">
                                <textarea id="<?php echo e($code); ?>__condition" class="editor"
                                          name="descriptions[<?php echo e($code); ?>][condition]">
                                        <?php echo old('descriptions.'.$code.'.condition'); ?>
                                    ...
                                    <div class="form-group row kind  <?php echo e($errors->has('descriptions.'.$code.'.delivery') ? ' text-red' : ''); ?>">
                                        <label for="<?php echo e($code); ?>__delivery" class="col-sm-2 col-form-label">
                                            Delivery
                                        </label>
                                        <div class="col-sm-8">
                                <textarea id="<?php echo e($code); ?>__delivery" class="editor"
                                          name="descriptions[<?php echo e($code); ?>][delivery]">
                                        <?php echo old('descriptions.'.$code.'.delivery'); ?>
                                    ...
                                    <div class="form-group row kind  <?php echo e($errors->has('descriptions.'.$code.'.warranty') ? ' text-red' : ''); ?>">
                                        <label for="<?php echo e($code); ?>__warranty" class="col-sm-2 col-form-label">
                                            Warranty
                                        </label>
                                        <div class="col-sm-8">
                                <textarea id="<?php echo e($code); ?>__warranty" class="editor"
                                          name="descriptions[<?php echo e($code); ?>][warranty]">
                                        <?php echo old('descriptions.'.$code.'.warranty'); ?>
                        ...
                        <div class="form-group row kind  <?php echo e($errors->has('category') ? ' text-red' : ''); ?>">
                            <?php
                                $listCate = [];
                        ...
                        <div class="form-group row kind  <?php echo e($errors->has('image') ? ' text-red' : ''); ?>">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div id="preview_image" class="img_holder">
                                    <?php if(old('image')): ?>
                                        <img src="<?php echo e(sc_file(old('image'))); ?>">
                                    <?php endif; ?>
                        ...
                        <div class="form-group row kind  <?php echo e($errors->has('sku') ? ' text-red' : ''); ?>">
                        ...
                        <div class="form-group row kind  <?php echo e($errors->has('alias') ? ' text-red' : ''); ?>">
                        ...
                        <?php if(sc_config_admin('product_brand')): ?>
                            ...
                            <div class="form-group row kind   <?php echo e($errors->has('brand_id') ? ' text-red' : ''); ?>">
                                <label for="brand_id"
                                       class="col-sm-2 col-form-label"><?php echo e(trans('product.brand')); ?> (<a target=_new href="<?php echo e(sc_route_admin('admin_brand.index')); ?>"><i class="fa fa-link" aria-hidden="true"></i></a>)</label>
                                <div class="col-sm-8">
                        ...
                        <?php if(sc_config_admin('product_supplier')): ?>
                            ...
                            <div class="form-group row kind   <?php echo e($errors->has('supplier_id') ? ' text-red' : ''); ?>">
                                <label for="supplier_id"
                                       class="col-sm-2 col-form-label"><?php echo e(trans('product.supplier')); ?> (<a target=_new href="<?php echo e(sc_route_admin('admin_supplier.index')); ?>"><i class="fa fa-link" aria-hidden="true"></i></a>)</label>
                                <div class="col-sm-8">
                        ...
                        <?php if(sc_config_admin('product_cost')): ?>
                            ...
                            <div class="form-group row kind   <?php echo e($errors->has('cost') ? ' text-red' : ''); ?>">
                        ...
                        <?php if(sc_config_admin('product_price')): ?>
                            ...
                            <div class="form-group row kind   <?php echo e($errors->has('price') ? ' text-red' : ''); ?>">
                        ...
                        <?php if(sc_config_admin('product_tax')): ?>
                            ...
                            <div class="form-group row kind   <?php echo e($errors->has('tax_id') ? ' text-red' : ''); ?>">
                                <label for="tax_id"
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control input-sm tax_id select2" style="width: 100%;"
                                            name="tax_id">
                                        <option value="0" <?php echo e((old('tax_id') == 0) ? 'selected':''); ?>><?php echo e(trans('tax.admin.non_tax')); ?> (<a target=_new href="<?php echo e(sc_route_admin('admin_tax.index')); ?>"><i class="fa fa-link" aria-hidden="true"></i></a>)</option>
                        ...
                        <?php if(sc_config_admin('product_promotion')): ?>
                            ...
                            <div class="form-group row kind    <?php echo e($errors->has('price_promotion') ? ' text-red' : ''); ?>">
                                <label for="price"
                        ...
                        <?php if(sc_config_admin('product_stock')): ?>
                            ...
                            <div class="form-group row kind   <?php echo e($errors->has('stock') ? ' text-red' : ''); ?>">
                        ...
                        <?php if(sc_config_admin('product_weight')): ?>
                            ...
                            <div class="form-group row kind    <?php echo e($errors->has('weight_class') ? ' text-red' : ''); ?>">
                                <label for="weight_class" class="col-sm-2 col-form-label"><?php echo e(trans('product.weight_class')); ?> (<a target=_new href="<?php echo e(sc_route_admin('admin_weight_unit.index')); ?>"><i class="fa fa-link" aria-hidden="true"></i></a>)</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row kind   <?php echo e($errors->has('weight') ? ' text-red' : ''); ?>">
                        ...
                        <?php if(sc_config_admin('product_length')): ?>
                            ...
                            <div class="form-group row kind    <?php echo e($errors->has('length_class') ? ' text-red' : ''); ?>">
                                <label for="length_class" class="col-sm-2 col-form-label"><?php echo e(trans('product.length_class')); ?> (<a target=_new href="<?php echo e(sc_route_admin('admin_length_unit.index')); ?>"><i class="fa fa-link" aria-hidden="true"></i></a>)</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row kind   <?php echo e($errors->has('length') ? ' text-red' : ''); ?>">
                            ...
                            <div class="form-group row kind   <?php echo e($errors->has('height') ? ' text-red' : ''); ?>">
                            ...
                            <div class="form-group row kind   <?php echo e($errors->has('width') ? ' text-red' : ''); ?>">
                        ...
                        <?php if(sc_config_admin('product_property')): ?>
                            ...
                            <div class="form-group row kind   <?php echo e($errors->has('property') ? ' text-red' : ''); ?>">
                                <label for="property" class="col-sm-2 col-form-label"><?php echo e(trans('product.property')); ?> (<a target=_new href="<?php echo e(sc_route_admin('admin_product_property.index')); ?>"><i class="fa fa-link" aria-hidden="true"></i></a>)</label>
                                <div class="col-sm-8">
                                    <?php $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="radioPrimary<?php echo e($key); ?>" name="property" value="<?php echo e($key); ?>" <?php echo e(((!old() && $key == SC_PROPERTY_PHYSICAL) || old('property') == $key)?'checked':''); ?>>
                                    ...
                                    <?php endif; ?>
                                    <div style="margin-top: 10px; <?php echo e((old('property') != SC_PROPERTY_DOWNLOAD) ? 'display:none':''); ?>" id="download_path">
                                        <input type="text"  name="download_path" value="<?php echo e(old('download_path')); ?>" class="form-control input-sm" placeholder="<?php echo e(trans('product.properties.download_path')); ?>" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php if(sc_config_admin('product_available')): ?>
                            ...
                            <div
                                    class="form-group row kind   <?php echo e($errors->has('date_available') ? ' text-red' : ''); ?>">
                        ...
                        <?php if(sc_config_admin('product_attribute')): ?>
                            ...
                            <?php if(!empty($attributeGroup)): ?>
                                ...
                                <div class="form-group kind  row">
                                    <div class="col-sm-2">
                                        <label><?php echo e(trans('product.attribute')); ?> (<a target=_new href="<?php echo e(sc_route_admin('admin_attribute_group.index')); ?>"><i class="fa fa-link" aria-hidden="true"></i></a>)</label>
                                    </div>
                                    <div class="col-sm-8">
                        ...
                        <?php if($customFields): ?>
                            <hr class="kind ">
                            <label><?php echo e(trans('custom_field.admin.title')); ?> (<a target=_new href="<?php echo e(sc_route_admin('admin_custom_field.index')); ?>"><i class="fa fa-link" aria-hidden="true"></i></a>)</label>
                            <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyField => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group row kind   <?php echo e($errors->has('fields.'.$field->code) ? ' text-red' : ''); ?>">
                                    <label for="<?php echo e($field->code); ?>" class="col-sm-2 col-form-label"><?php echo e(sc_language_render($field->name)); ?></label>
                                    ...
                                    <div class="col-sm-8">
                                        <?php if($field->option == 'radio'): ?>
                                            <?php if($default): ?>
                                                <?php $__currentLoopData = $default; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="icheck-primary d-inline">
                                                        <input type="radio" id="<?php echo e($keyField.'__'.$key); ?>" name="fields[<?php echo e($field->code); ?>]" value="<?php echo e($key); ?>" <?php echo e((old('fields.'.$field->code) == $key)?'checked':''); ?>>
                                        ...
                                        <?php elseif($field->option == 'select'): ?>
                                            <?php if($default): ?>
                                                <select class="form-control input-sm <?php echo e($field->code); ?>" style="width: 100%;"
                                                        name="fields[<?php echo e($field->code); ?>]">
                                                    <option value=""></option>
                                                    <?php $__currentLoopData = $default; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>" <?php echo e((old('fields.'.$field->code) == $key) ? 'selected':''); ?>><?php echo e($name); ?>
                                        ...
                                        <?php else: ?>
                                            <textarea  id="field_<?php echo e($field->code); ?>" name="fields[<?php echo e($field->code); ?>]"
                                                       class="form-control <?php echo e($field->code); ?>" placeholder="" ><?php echo e(old('fields.'.$field->code)); ?></textarea>
                                        <?php endif; ?>
                    ...
                    <div class="card-footer clearfix" id="card-footer">
                        <?php echo csrf_field(); ?>
                        <div class="col-md-2">
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($templatePathAdmin.'layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\eshop\resources\views/admin/screen/product_add.blade.php ENDPATH**/ ?>