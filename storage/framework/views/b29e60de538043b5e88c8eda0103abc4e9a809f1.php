...
?>
<!DOCTYPE html>
<html <?php if(session('layout') == 1): ?> direction="rtl" dir="rtl" style="direction: rtl" <?php else: ?> lang="<?php echo e(config('app.locale')); ?>"  <?php endif; ?>>
	<!--begin::Head-->
	<head><base href="">
		<meta charset="utf-8" />
    ...
    <?php if(session('layout') == 1): ?>
		...
		<link href="<?php echo e(sc_file('admin/metro/assets/plugins/custom/fullcalendar/fullcalendar.bundle.rtl.css')); ?>" rel="stylesheet" type="text/css" />
		<!--end::Page Vendors Styles-->
		<!--begin::Global Theme Styles(used by all pages)-->
		<link href="<?php echo e(sc_file('admin/metro/assets/plugins/global/plugins.bundle.rtl.css')); ?>" rel="stylesheet" type="text/css" />
		<link href="<?php echo e(sc_file('admin/metro/assets/plugins/custom/prismjs/prismjs.bundle.rtl.css')); ?>" rel="stylesheet" type="text/css" />
		<link href="<?php echo e(sc_file('admin/metro/assets/css/style.bundle.rtl.css')); ?>" rel="stylesheet" type="text/css" />
		<!--end::Global Theme Styles-->
		<!--begin::Layout Themes(used by all pages)-->
		<link href="<?php echo e(sc_file('admin/metro/assets/css/themes/layout/header/base/light.rtl.css')); ?>" rel="stylesheet" type="text/css" />
		<link href="<?php echo e(sc_file('admin/metro/assets/css/themes/layout/header/menu/light.rtl.css')); ?>" rel="stylesheet" type="text/css" />
		<link href="<?php echo e(sc_file('admin/metro/assets/css/themes/layout/brand/dark.rtl.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(sc_file('admin/metro/assets/css/themes/layout/aside/dark.rtl.css')); ?>" rel="stylesheet" type="text/css" />
    <?php else: ?>
    <!--begin::Page Vendors Styles(used by this page)-->
		<link href="<?php echo e(sc_file('admin/metro/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css')); ?>" rel="stylesheet" type="text/css" />
		<!--end::Page Vendors Styles-->
		<!--begin::Global Theme Styles(used by all pages)-->
    ...
    <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo e(sc_file('admin/metro/assets/css/square/blue.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(sc_file('admin/metro/assets/css/icheck-bootstrap/icheck-bootstrap.min.css')); ?>">


    <?php if(!Admin::isLoginPage() && !Admin::isLogoutPage()): ?>
    <?php $__env->startSection('block_component_css'); ?>
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading <?php echo e(config($styleDefine.'.body')); ?>" <?php if(session('layout') == 1): ?> dir="rtl" <?php endif; ?>>

  <?php if((Admin::isLoginPage() || Admin::isLogoutPage())): ?>
    <?php echo $__env->yieldContent('main'); ?>
  <?php else: ?>

  <?php $__env->startSection('block_component_exception'); ?>
  ...
  <div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row flex-column-fluid page">
      ...
      <?php $__env->startSection('block_sidebar'); ?>
...
<script>var HOST_URL = "https://preview.keenthemes.com/metronic/theme/html/tools/preview";</script>
    ...
    <script src="<?php echo e(sc_file('admin/metro/assets/js/pages/icheck.min.js')); ?>"></script>
    <!--end::Page Scripts-->
    
    <?php echo $__env->yieldPushContent('scripts'); ?>

    <?php $__env->startSection('block_component_script'); ?>
    ...
    <?php $__env->startSection('block_component_alerts'); ?>
	...
	<!--end::Body-->
</html><?php /**PATH C:\xampp7\htdocs\eshop\resources\views/admin/layout.blade.php ENDPATH**/ ?>