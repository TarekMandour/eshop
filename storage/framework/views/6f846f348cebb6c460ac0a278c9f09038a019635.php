<?php
$productPromotion = $modelProduct->start()->setLimit(sc_config('product_viewed'))->getData()
// $getProductLatest = $modelProduct->getProductLatest()->setLimit(sc_config('product_viewed'))->getData();
...
<?php /**PATH C:\xampp7\htdocs\eshop\resources\views/templates/eshop/block/products_slider.blade.php ENDPATH**/ ?>