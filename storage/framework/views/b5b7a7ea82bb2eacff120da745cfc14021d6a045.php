...
(function( $ ){
      ...
      $.fn.filemanager = function(type, options) {
        ...
        this.on('click', function(e) {
          ...
          var route_prefix = (options && options.prefix) ? options.prefix : '<?php echo e(sc_route_admin('admin.home').'/'.config('lfm.url_prefix')); ?>';
...
<script>
    ...
    $('.select2').select2();
</script><?php /**PATH C:\xampp7\htdocs\eshop\resources\views/admin/component/script.blade.php ENDPATH**/ ?>