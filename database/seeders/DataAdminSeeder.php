...
class DataAdminSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::connection(SC_CONNECTION)->table(SC_DB_PREFIX.'admin_store_description')->insert(
            [
                ['store_id' => '1', 'lang' => 'en', 'title' => 'EShop : Laravel eCommerce', 'description' => 'website shopping cart for business', 'keyword' => '', 'maintain_content' => '<center><img src="/images/maintenance.png" />
    <h3><span style="color:#e74c3c;"><strong>Sorry! We are currently doing site maintenance!</strong></span></h3>
    </center>', 'maintain_note' => 'Website is in maintenance mode!'],
                ['store_id' => '1', 'lang' => 'vi', 'title' => 'EShop: Mã nguồn website thương mại điện tử miễn phí', 'description' => 'Laravel shopping cart for business', 'keyword' => '', 'maintain_content' => '<center><img src="/images/maintenance.png" />
