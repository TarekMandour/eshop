@php
    $totalOrder = \EShop\Core\Admin\Models\AdminOrder::count();
    $styleStatus = \EShop\Core\Admin\Models\AdminOrder::$mapStyleStatus;
@endphp
@if ($totalOrder)
@php
    $arrStatus = \EShop\Core\Front\Models\ShopOrderStatus::pluck('name','id')->all();
    $groupOrder = (new \EShop\Core\Front\Models\ShopOrder)->all()->groupBy('status');
@endphp
    <li id="summary">
    <ul>
