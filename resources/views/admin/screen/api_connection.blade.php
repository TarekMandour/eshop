                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header with-border">
                        <div class="card-toolbar">
                            <h3 class="card-title">{!! $title_action !!}</h3></div>

                        <div class="card-title">
                            @if ($layout == 'edit')
                                <div class="btn-group float-right" style="margin-right: 5px">
                                    <a href="{{ sc_route_admin('admin_api_connection.index') }}"
                                       class="btn btn-flat btn-default" title="List"><i class="fa fa-list"></i>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row {{ $errors->has('description') ? ' text-red' : '' }}">
                                <label for="description"
                                       class="col-sm-2 col-form-label">{{ trans('api_connection.description') }}</label>
                                <div class="col-sm-10 ">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="description" name="description"
                                               value="{!! old()?old('description'):$api_connection['description']??'' !!}"
                    ...
                    <i class="fa fa-info-circle"></i> {{ $errors->first('description') }}
                            ...
                            <div class="form-group row {{ $errors->has('apiconnection') ? ' text-red' : '' }}">
                                <label for="apiconnection"
                                       class="col-sm-2 col-form-label">{{ trans('api_connection.apiconnection') }}</label>
                                <div class="col-sm-10 ">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                        </div>
                                        <input type="text" id="apiconnection" name="apiconnection"
                                               value="{!! old()?old('apiconnection'):$api_connection['apiconnection']??'' !!}"
                                               class="form-control apiconnection {{ $errors->has('apiconnection') ? ' is-invalid' : '' }}">
                                    </div>
                    ...
                    <i class="fa fa-info-circle"></i> {{ $errors->first('apiconnection') }}
                            ...
                            <div class="form-group row {{ $errors->has('apikey') ? ' text-red' : '' }}">
                                <label for="apikey"
                                       class="col-sm-2 col-form-label">{{ trans('api_connection.apikey') }}</label>
                                <div class="col-sm-10 ">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                        ...
                                        <input type="text" id="apikey" name="apikey"
                                               value="{!! old()?old('apikey'):$api_connection['apikey']??'' !!}"
                                               class="form-control apikey {{ $errors->has('apikey') ? ' is-invalid' : '' }}">
                                ...
                                <div class="col-sm-10 ">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="expire" name="expire"
                                               value="{!! old()?old('expire'):$api_connection['expire']??'' !!}"
                                               class="form-control expire date_time {{ $errors->has('expire') ? ' is-invalid' : '' }}">
                                    </div>
                    ...
                    <i class="fa fa-info-circle"></i> {{ $errors->first('expire') }}
                            ...
                            <div class="form-group row {{ $errors->has('status') ? ' text-red' : '' }}">
                                <label for="status"
                                       class="col-sm-2 col-form-label">{{ trans('api_connection.status') }}</label>
                                <div class="col-sm-10 ">
                                    <div class="input-group mb-3">
                                        <input class="checkbox" type="checkbox"
                                               name="status" {{ old('status',(empty($api_connection['status'])?0:1))?'checked':''}}>
                                    </div>
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-md-12 m-2">
                                <input class="switch-data-config" name="api_connection_required"
                                       type="checkbox" {{ (sc_config_global('api_connection_required')?'checked':'') }}><br> {!! trans('api_connection.api_connection_required_help') !!}
                            </div>
                        </div>
                    </div>
                </div>
