                        ...
                        <div class="card-title">
                            @if ($layout == 'edit')
                                <div class="btn-group float-right" style="margin-right: 5px">
                                    <a href="{{ sc_route_admin('admin_shipping_status.index') }}"
                    ...
                    <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal"
                        ...
                        <div class="card-body">
                            <div class="form-group row {{ $errors->has('name') ? ' text-red' : '' }}">
                                <label for="name"
                                       class="col-sm-2 col-form-label">{{ trans('shipping_status.name') }}</label>
                                <div class="col-sm-10 ">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="name" name="name"
                                               value="{!! old()?old('name'):$shipping_status['name']??'' !!}"
