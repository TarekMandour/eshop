            ...
            <div class="card card-custom gutter-b">
                <div class="card-header with-border">
                    ...
                    <div class="card-body" id="pjax-container">
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn btn-default btn-flat"><i class="fa fa-save"></i> Backup
                            </button>
                            <button type="button" class="btn btn-default btn-flat dropdown-toggle"
                                    data-toggle="dropdown" data-loading-text="{{ trans('backup.processing') }}">
                            ...
                            <ul class="dropdown-menu keep-open" role="menu">
                                        ...
                                        @foreach ($tableInfo as $table)
                                            <tr>
                                                <td class="checkbox icheck">
                                                    <input type="checkbox" class="column-select-item table-process"
                                                           data-id="{{ $table->table_name }}" checked/>
                                                </td>
                                                <td>
                                                    {{ $table->table_name }}
                                                </td>
                                ...
                                <li>
                                    ...
                                    <div class="float-right">
                                        ...
                                        <button class="btn btn-sm btn-success column-select-submit"
                                                onClick="generateBackup($(this));" id="generate">Submit
                                        </button>
                                    </div>
                            ...
                            <table id="main-table" class="table table-hover box-body text-wrap table-bordered">
                                ...
                                @foreach ($arrFiles as $file)
                                    <tr>
                                        ...
                                        <td>{{ $file['name']}}</td>
                                        <td>{{ $file['size']}}</td>
                                        <td>{!! '<a href="?download='.$file['name'].'"><button title="'.trans('backup.download').'" data-loading-text="'.trans('backup.processing').'" class="btn btn-flat btn-primary"><i class="fas fa-download"></i> '.trans('backup.download').'</button ></a>' !!}</td>
