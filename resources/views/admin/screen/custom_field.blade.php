            ...
            <div class="d-flex flex-column-fluid">
                            ...
                            <div class="card-title">
                                @if ($layout == 'edit')
                                    <div class="btn-group float-right" style="margin-right: 5px">
                                        <a href="{{ sc_route_admin('admin_custom_field.index') }}"
                        ...
                        <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row {{ $errors->has('name') ? ' text-red' : '' }}">
                                    <label for="name"
                                           class="col-sm-2 col-form-label">{{ trans('custom_field.name') }}</label>
                                    <div class="col-sm-10 ">
                ...
                <i class="fa fa-info-circle"></i> {{ $errors->first('name') }}
                                ...
                                <div class="form-group row {{ $errors->has('code') ? ' text-red' : '' }}">
                                    <label for="code"
                                           class="col-sm-2 col-form-label">{!! trans('custom_field.code') !!}</label>
                                    <div class="col-sm-10 ">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            ...
                                            <input type="text" id="code" name="code"
                                                   value="{!! old('code', ($customField['code']??'')) !!}"
                ...
                <i class="fa fa-info-circle"></i> {{ $errors->first('code') }}
                                ...
                                <div class="form-group row {{ $errors->has('type') ? ' text-red' : '' }}">
                                    <label for="type"
                                           class="col-sm-2 col-form-label">{!! trans('custom_field.type') !!}</label>
                                    <div class="col-sm-10 ">
                                        <div class="input-group mb-3">
                ...
                <i class="fa fa-info-circle"></i> {{ $errors->first('type') }}
                                ...
                                <div class="form-group row {{ $errors->has('option') ? ' text-red' : '' }}">
                                    <label for="option"
                                           class="col-sm-2 col-form-label">{!! trans('custom_field.option') !!}</label>
                                    <div class="col-sm-10 ">
                                        <div class="input-group mb-3">
                ...
                <i class="fa fa-info-circle"></i> {{ $errors->first('option') }}
                                ...
                                <div class="form-group row {{ $errors->has('default') ? ' text-red' : '' }}">
                                    <label for="default"
                                           class="col-sm-2 col-form-label">{!! trans('custom_field.default') !!}</label>
                                    <div class="col-sm-10 ">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            ...
                                            <input type="text" id="default" name="default"
                                                   value="{{ old('default', ($customField['default']??'')) }}"
                                                   class="form-control default {{ $errors->has('default') ? ' is-invalid' : '' }}">
                                        </div>
                ...
                <i class="fa fa-info-circle"></i> {{ $errors->first('default') }}
                                        ...
                                        @else
                                            <span class="text-sm">
                <i class="fa fa-info-circle"></i> {!! trans('custom_field.default_help') !!}
              </span>
                                        @endif
                                ...
                                <div class="form-group row {{ $errors->has('required') ? ' text-red' : '' }}">
                                    <label for="required"
                                           class="col-sm-2 col-form-label">{!! trans('custom_field.required') !!}</label>
                                    <div class="col-sm-10 ">
                                        <div class="input-group mb-3">
                                            <input class="checkbox" type="checkbox" id="required" name="required"
                                                   class="form-control input {{ $errors->has('required') ? ' is-invalid' : '' }}"
                                                   placeholder="" {!!
                ...
                <i class="fa fa-info-circle"></i> {{ $errors->first('required') }}
                                ...
                                <div class="form-group row {{ $errors->has('status') ? ' text-red' : '' }}">
                                    <label for="status"
                                           class="col-sm-2 col-form-label">{!! trans('custom_field.status') !!}</label>
                                    <div class="col-sm-10 ">
                                        <div class="input-group mb-3">
                                            <input class="checkbox" type="checkbox" id="status" name="status"
                                                   class="form-control input {{ $errors->has('status') ? ' is-invalid' : '' }}"
                                                   placeholder="" {!!
                ...
                <i class="fa fa-info-circle"></i> {{ $errors->first('status') }}
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit"
                                        class="btn btn-primary float-right">{{ trans('admin.submit') }}</button>
                            </div>
                            <!-- /.card-footer -->
                        </form>
                    </div>
                                                ...
                                                @if (!empty($removeList))
                                                    <td>
                                                        <input class="checkbox" type="checkbox"
                                                               class="grid-row-checkbox" data-id="{{ $tr['id']??'' }}">
                                                    </td>
                                                @endif
