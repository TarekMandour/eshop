                    ...
                    <div class="card-header with-border">
                        ...
                        <div class="card-title">
                            <div class="btn-group float-right" style="margin-right: 5px">
                                <a href="{{ sc_route_admin('admin_currency.index') }}" class="btn  btn-flat btn-default"
                        ...
                        <div class="card-body">
                            <div class="fields-group">
                                ...
                                <div class="form-group row  {{ $errors->has('name') ? ' text-red' : '' }}">
                                    <label for="name"
                                           class="col-sm-2 col-form-label">{{ trans('currency.name') }}</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="name" name="name"
                                                   value="{!! old()?old('name'):$currency['name']??'' !!}"
                                ...
                                <div class="form-group row  {{ $errors->has('code') ? ' text-red' : '' }}">
                                    <label for="code"
                                           class="col-sm-2 col-form-label">{{ trans('currency.code') }}</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            ...
                                            @if (!empty($currency['code']) && in_array($currency['code'], ['VND','USD']))
                                                <input type="hidden" id="code" name="code"
                                                       value="{!! $currency['code'] !!}" placeholder=""/>
                                                <input type="text" disabled="disabled" value="{!! $currency['code'] !!}"
                                                       class="form-control" placeholder=""/>
                                            @else
                                                <input type="text" id="code" name="code"
                                                       value="{!! old()?old('code'):$currency['code']??'' !!}"
                                                       class="form-control" placeholder=""/>
                                            @endif
                                ...
                                <div class="form-group row  {{ $errors->has('symbol') ? ' text-red' : '' }}">
                                    <label for="symbol"
                                           class="col-sm-2 col-form-label">{{ trans('currency.symbol') }}</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            ...
                                            <input type="text" id="symbol" name="symbol"
                                                   value="{!! old()?old('symbol'):$currency['symbol']??'' !!}"
                                                   class="form-control" placeholder=""/>
                                        </div>
                                ...
                                <div class="form-group row  {{ $errors->has('exchange_rate') ? ' text-red' : '' }}">
                                    <label for="exchange_rate"
                                           class="col-sm-2 col-form-label">{{ trans('currency.exchange_rate') }}</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            ...
                                            <input type="number" step="0.01" id="exchange_rate" name="exchange_rate"
                                                   value="{!! old()?old('exchange_rate'):$currency['exchange_rate']??1 !!}"
                                                   class="form-control" placeholder=""/>
                                        </div>
                                ...
                                <div class="form-group row  {{ $errors->has('precision') ? ' text-red' : '' }}">
                                    <label for="precision"
                                           class="col-sm-2 col-form-label">{{ trans('currency.precision') }}</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            ...
                                            <input type="number" id="precision" name="precision" type=""
                                                   value="{!! old()?old('precision'):$currency['precision']??0 !!}"
                                ...
                                <div class="form-group row {{ $errors->has('symbol_first') ? ' text-red' : '' }}">
                                    <label for="symbol_first"
                                           class="col-sm-2 col-form-label">{{ trans('currency.symbol_first') }}</label>
                                    <div class="col-sm-8">
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="radioPrimary1" name="symbol_first"
                                                   value="1" {!! (old('symbol_first',$currency['symbol_first']??1) =='1')?'checked':'' !!}>
                                        ...
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="radioPrimary0" name="symbol_first"
                                                   value="0" {!! (old('symbol_first',$currency['symbol_first']??0) =='0')?'checked':'' !!}>
                                ...
                                <div class="form-group row  {{ $errors->has('thousands') ? ' text-red' : '' }}">
                                    <label for="thousands"
                                           class="col-sm-2 col-form-label">{{ trans('currency.thousands') }}</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            ...
                                            <input type="text" id="thousands" name="thousands" type="text"
                                                   value="{!! old('thousands',$currency['thousands']??',') !!}"
                                                   class="form-control" placeholder=""/>
                                        </div>
                                ...
                                <div class="form-group row  {{ $errors->has('sort') ? ' text-red' : '' }}">
                                    <label for="sort"
                                           class="col-sm-2 col-form-label">{{ trans('currency.sort') }}</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            ...
                                            <input type="number" style="width: 100px;" min=0 id="sort" name="sort"
                                                   value="{!! old('sort',$currency['sort']??0) !!}"
                                ...
                                <div class="form-group row">
                                    <label for="status"
                                           class="col-sm-2 col-form-label">{{ trans('currency.status') }}</label>
                                    <div class="col-sm-8">
                                        <input class="checkbox" type="checkbox"
                                               name="status" {!! old('status',(empty($currency['status'])?0:1))?'checked':''!!}>
                                ...
                                <div class="card-footer row" id="card-footer">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="btn-group float-left">
                                            <button type="reset"
                                                    class="btn btn-warning">{{ trans('admin.reset') }}</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-footer -->
