            ...
            <div class="container py-8">
                        ...
                        <div class="card-title">
                            @if ($layout == 'edit')
                                <div class="btn-group float-right" style="margin-right: 5px">
                                    <a href="{{ sc_route_admin('admin_attribute_group.index') }}"
                    ...
                    <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row {{ $errors->has('name') ? ' text-red' : '' }}">
                                <label for="name"
                                       class="col-sm-2 col-form-label">{{ trans('attribute_group.name') }}</label>
                                <div class="col-sm-10 ">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="name" name="name"
                                               value="{!! old()?old('name'):$attribute_group['name']??'' !!}"
                ...
                <i class="fa fa-info-circle"></i> {{ $errors->first('name') }}
                            ...
                            <div class="form-group row {{ $errors->has('type') ? ' text-red' : '' }}">
                                <label for="type"
                                       class="col-sm-2 col-form-label">{{ trans('attribute_group.type') }}</label>
                                <div class="form-group clearfix">
                                    <div class="icheck-primary d-inline">
                                        <input type="radio" id="radioPrimary1" name="type"
                                               value="radio" {{ (old('type',($attribute_group['type']??'')) =='radio')?'checked':'' }}>
                                    ...
                                    <div class="icheck-primary d-inline">
                                        <input type="radio" id="radioPrimary2" name="type"
                                               value="select" {{ (old('type',($attribute_group['type']??'')) =='select')?'checked':'' }}>
