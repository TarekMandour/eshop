                    ...
                    <div class="card-body">
                        ...
                        @foreach ($languages as $code => $language)
                            <div class="card card-{{ ($product->kind == 1) ? 'success': (($product->kind == 2) ? 'danger': '') }}">
                                ...
                                <textarea id="{{ $code }}__content" class="editor"
                                    ...
                                    @if ($product->kind == SC_PRODUCT_SINGLE)
                                        <div
                                                class="form-group row {{ $errors->has('descriptions.'.$code.'.specifications') ? ' text-red' : '' }}">
                                            <label for="{{ $code }}__specifications"
                                                   class="col-sm-2 col-form-label">Specifications</label>
                                            <div class="col-sm-8">
                                <textarea id="{{ $code }}__specifications" class="editor"
                                          name="descriptions[{{ $code }}][specifications]">
                                    {!! old('descriptions.'.$code.'.specifications',($descriptions[$code]['specifications']??'')) !!}</textarea>
                                                @if ($errors->has('descriptions.'.$code.'.specifications'))
                                                    <span class="form-text">
                                                        <i class="fa fa-info-circle"></i>
                                                        {{ $errors->first('descriptions.'.$code.'.specifications') }}
                                                    </span>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    @if ($product->kind == SC_PRODUCT_SINGLE)
                                        <div
                                                class="form-group row {{ $errors->has('descriptions.'.$code.'.condition') ? ' text-red' : '' }}">
                                            <label for="{{ $code }}__condition"
                                                   class="col-sm-2 col-form-label">Condition</label>
                                            <div class="col-sm-8">
                                <textarea id="{{ $code }}__condition" class="editor"
                                          name="descriptions[{{ $code }}][condition]">
                                    {!! old('descriptions.'.$code.'.condition',($descriptions[$code]['condition']??'')) !!}</textarea>
                                                @if ($errors->has('descriptions.'.$code.'.condition'))
                                                    <span class="form-text">
                                                        <i class="fa fa-info-circle"></i>
                                                        {{ $errors->first('descriptions.'.$code.'.condition') }}
                                                    </span>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    @if ($product->kind == SC_PRODUCT_SINGLE)
                                        <div
                                                class="form-group row {{ $errors->has('descriptions.'.$code.'.delivery') ? ' text-red' : '' }}">
                                            <label for="{{ $code }}__delivery"
                                                   class="col-sm-2 col-form-label">delivery & Return</label>
                                            <div class="col-sm-8">
                                <textarea id="{{ $code }}__delivery" class="editor"
                                          name="descriptions[{{ $code }}][delivery]">
                                    {!! old('descriptions.'.$code.'.delivery',($descriptions[$code]['delivery']??'')) !!}</textarea>
                                                @if ($errors->has('descriptions.'.$code.'.delivery'))
                                                    <span class="form-text">
                                                        <i class="fa fa-info-circle"></i>
                                                        {{ $errors->first('descriptions.'.$code.'.delivery') }}
                                                    </span>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    @if ($product->kind == SC_PRODUCT_SINGLE)
                                        <div
                                                class="form-group row {{ $errors->has('descriptions.'.$code.'.warranty') ? ' text-red' : '' }}">
                                            <label for="{{ $code }}__warranty"
                                                   class="col-sm-2 col-form-label">Warranty</label>
                                            <div class="col-sm-8">
                                <textarea id="{{ $code }}__warranty" class="editor"
                                          name="descriptions[{{ $code }}][warranty]">
                                    {!! old('descriptions.'.$code.'.warranty',($descriptions[$code]['warranty']??'')) !!}</textarea>
                                                @if ($errors->has('descriptions.'.$code.'.warranty'))
                                                    <span class="form-text">
                                                        <i class="fa fa-info-circle"></i>
                                                        {{ $errors->first('descriptions.'.$code.'.warranty') }}
                                                    </span>
                                                @endif
                                            </div>
                                        </div>
                        ...
                        @if (sc_config_admin('product_brand') && ($product->kind == SC_PRODUCT_SINGLE || $product->kind == SC_PRODUCT_BUILD))
                            ...
                            <div class="form-group row kind kind0 kind1 {{ $errors->has('brand_id') ? ' text-red' : '' }}">
                                <label for="brand_id" class="col-sm-2 col-form-label">{{ trans('product.brand') }} (<a
                                            href="{{ sc_route_admin('admin_brand.index') }}"><i class="fa fa-link"
                        ...
                        @if (sc_config_admin('product_supplier') && ($product->kind == SC_PRODUCT_SINGLE || $product->kind == SC_PRODUCT_BUILD))
                            ...
                            <div class="form-group row kind kind0 kind1 {{ $errors->has('supplier_id') ? ' text-red' : '' }}">
                                <label for="supplier_id" class="col-sm-2 col-form-label">{{ trans('product.supplier') }}
                                    (<a href="{{ sc_route_admin('admin_supplier.index') }}"><i class="fa fa-link"
                                                                                               aria-hidden="true"></i></a>)</label>
                                <div class="col-sm-8">
                            ...
                            @if (sc_config_admin('product_tax'))
                                @if ($product->kind == SC_PRODUCT_SINGLE || $product->kind == SC_PRODUCT_BUILD)
                                    ...
                                    <div class="form-group row {{ $errors->has('tax_id') ? ' text-red' : '' }}">
                                        <label for="tax_id" class="col-sm-2 col-form-label">{{ trans('product.tax') }} (<a
                                                    href="{{ sc_route_admin('admin_tax.index') }}"><i class="fa fa-link"
                                                                                                      aria-hidden="true"></i></a>)</label>
                                        <div class="col-sm-8">
                            ...
                            @if ($product->kind == SC_PRODUCT_SINGLE || $product->kind == SC_PRODUCT_BUILD)
                                ...
                                <div class="form-group row {{ $errors->has('weight_class') ? ' text-red' : '' }}">
                                    <label for="weight_class"
                                           class="col-sm-2 col-form-label">{{ trans('product.weight_class') }} (<a
                                                href="{{ sc_route_admin('admin_weight_unit.index') }}"><i
                            ...
                            @if ($product->kind == SC_PRODUCT_SINGLE || $product->kind == SC_PRODUCT_BUILD)
                                ...
                                <div class="form-group row {{ $errors->has('length_class') ? ' text-red' : '' }}">
                                    <label for="length_class"
                                           class="col-sm-2 col-form-label">{{ trans('product.length_class') }} (<a
                                                href="{{ sc_route_admin('admin_length_unit.index') }}"><i
                                                    class="fa fa-link" aria-hidden="true"></i></a>)</label>
                                    <div class="col-sm-8">
                        ...
                        @if (sc_config_admin('product_property'))
                            ...
                            @if ($product->kind == SC_PRODUCT_SINGLE)
                                <div class="form-group row kind kind0 kind1  {{ $errors->has('property') ? ' text-red' : '' }}">
                                    <label for="property"
                                           class="col-sm-2 col-form-label">{{ trans('product.property') }} (<a
                                                href="{{ sc_route_admin('admin_product_property.index') }}"><i
                                                    class="fa fa-link" aria-hidden="true"></i></a>)</label>
                                    <div class="col-sm-8">
                                        @foreach ( $properties as $key => $property)
                                            <div class="icheck-primary d-inline">
                                                <input type="radio" id="radioPrimary{{ $key }}" name="property"
                                                       value="{{ $key }}" {{ (old('property',$product->property) == $key)?'checked':'' }}>
                                    ...
                                    <i class="fa fa-info-circle"></i> {{ $errors->first('property') }}
                                        ...
                                        <div class="input-group"
                                             style="margin-top: 10px; {{ (old('property', $product->property) != SC_PROPERTY_DOWNLOAD) ? 'display:none':'' }}"
                                             id="download_path">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fa fa-download"></i></span>
                                            </div>
                                            <input type="text" name="download_path"
                                                   value="{{ old('download_path', $product->downloadPath->path ?? '') }}"
                                                   class="form-control input-sm"
                                                   placeholder="{{ trans('product.properties.download_path') }}"/>
                                        </div>
                        ...
                        @if (sc_config_admin('product_attribute'))
                            @if ($product->kind == SC_PRODUCT_SINGLE)
                                ...
                                @if (!empty($attributeGroup))
                                    <div class="form-group row">
                                        <div class="col-sm-2">
                                            <label>{{ trans('product.attribute') }} (<a
                                                        href="{{ sc_route_admin('admin_attribute_group.index') }}"><i
                                                            class="fa fa-link" aria-hidden="true"></i></a>)</label>
                                        </div>
                                        <div class="col-sm-8">
                        ...
                        @if (isset($customFields) && $customFields)
                            ...
                            @endphp
                            <hr class="kind ">
                            <label>{{ trans('custom_field.admin.title') }} (<a target=_new
                                                                               href="{{ sc_route_admin('admin_custom_field.index') }}"><i
                                            class="fa fa-link" aria-hidden="true"></i></a>)</label>
                            @foreach ($customFields as $keyField => $field)
                                ...
                                <div class="form-group row kind   {{ $errors->has('fields.'.$field->code) ? ' text-red' : '' }}">
                                    <label for="{{ $field->code }}"
                                           class="col-sm-2 col-form-label">{{ sc_language_render($field->name) }}</label>
                                    ...
                                    <div class="col-sm-8">
                                                ...
                                                @foreach ($default as $key => $name)
                                                    <div class="icheck-primary d-inline">
                                                        <input type="radio" id="{{ $keyField.'__'.$key }}"
                                                               ...
                                                               value="{{ $key }}" {{ (old('fields.'.$field->code, ($fields[$field->code]['text'] ?? '')) == $key)?'checked':'' }}>
                                        ...
                                        @else
                                            <textarea id="field_{{ $field->code }}" name="fields[{{ $field->code }}]"
                                                      class="form-control {{ $field->code }}"
                                                      placeholder="">{{ old('fields.'.$field->code, ($fields[$field->code]['text'] ?? '')) }}</textarea>
                                        @endif
