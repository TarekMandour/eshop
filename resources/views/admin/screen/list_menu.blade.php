            ...
            <div class="card card-custom gutter-b">
                <div class="card-header with-border">
                    <div class="card-toolbar">
                        <a class="btn btn-warning btn-flat menu-sort-save" title="Save"><i class="fa fa-save"></i><span
                                    class="hidden-xs">&nbsp;Save</span></a>
                    </div>
                </div>
                ...
                <div class="card-body p-0">
                    <div class="box-body table-responsive">
                      ...
                      <a href="{{ sc_route_admin('admin_menu.edit',['id'=>$level0->id]) }}"><i
                                                        ...
                                                        @if($level1->uri)
                                                            <li class="dd-item" data-id="{{ $level1->id }}">
                                                                <div class="dd-handle {{ ($level1->id == $id)? 'active-item' : '' }}">
                                                                    ...
                                                                    <span class="float-right dd-nodrag">
                              <a href="{{ sc_route_admin('admin_menu.edit',['id'=>$level1->id]) }}"><i
                                          class="fa fa-edit fa-edit"></i></a>
                              &nbsp; 
                                                                            ...
                                                                            @if($level2->uri)
                                                                                <li class="dd-item"
                                                                                    ...
                                                                                    <div class="dd-handle {{ ($level2->id == $id)? 'active-item' : '' }}">
                                                                                        ...
                                                                                        <span class="float-right dd-nodrag">
                                          <a href="{{ sc_route_admin('admin_menu.edit',['id'=>$level2->id]) }}"><i
                                                      class="fa fa-edit fa-edit"></i></a>
                                          &nbsp; 
                                          <a data-id="{{ $level2->id }}" class="remove_menu"><i
                                                      class="fa fa-trash fa-edit"></i></a>
                                      </span>
                                                                                    </div>
                                                                                </li>
                                                                            @else
                    ...
                    @if ($layout == 'edit')
                        <div class="card-tools">
                            <div class="btn-group float-right" style="margin-right: 5px">
                                <a href="{{ sc_route_admin('admin_menu.index') }}" class="btn  btn-flat btn-default"
                ...
                <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('parent_id') ? ' text-red' : '' }}">
                            <label for="parent_id"
                                   class="col-sm-2 col-form-label">{{ trans('menu.admin.parent') }}</label>
                            <div class="col-sm-10 ">
                            ...
                            <div class="col-sm-10 ">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="title" name="title"
                                           value="{!! old()?old('title'):$menu['title']??'' !!}"
                              ...
                              <span class="input-group-addon">
                                <i class="fas fa-pencil-alt"></i>
                                    ...
                                    <input required="1" style="width: 140px" type="text" id="icon" name="icon"
                                           value="{!! old()?old('icon'):$menu['icon']??'fas fa-bars' !!}"
                                           class="form-control icon {{ $errors->has('icon') ? ' is-invalid' : '' }} "
                            ...
                            <div class="col-sm-10 ">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="uri" name="uri"
                                           value="{!! old()?old('uri'):$menu['uri']??'' !!}"
                                           class="form-control uri {{ $errors->has('uri') ? ' is-invalid' : '' }}"
                            ...
                            <div class="col-sm-10 ">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" style="width: 100px;" id="sort" name="sort"
                                           value="{!! old()?old('sort'):$menu['sort']??'' !!}"
                                           class="form-control sort {{ $errors->has('sort') ? ' is-invalid' : '' }}"
