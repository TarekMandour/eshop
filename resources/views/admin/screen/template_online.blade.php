...
@section('main')
    ...
    <div class="card card-primary card-outline card-outline-tabs">
      <div class="card-header p-0 border-bottom-0">
        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
          <li class="nav-item">
            <a class="nav-link" href="{{ sc_route_admin('admin_template.index') }}" >{{ trans('template.local') }}</a>
          </li>
          <li class="nav-item">
  ...
  function($version){
  return '<span title="EShop version '.$version.'" class="badge badge-primary">'.$version.'</span>';
  },$scVersion)
  );
