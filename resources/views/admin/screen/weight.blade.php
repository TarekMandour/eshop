                            ...
                            <div class="card-title">
                                @if ($layout == 'edit')
                                    <div class="btn-group float-right" style="margin-right: 5px">
                                        <a href="{{ sc_route_admin('admin_weight_unit.index') }}"
                                    ...
                                    <div class="col-sm-10 ">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" id="name" name="name"
                                                   value="{!! old()?old('name'):$weight['name']??'' !!}"
                ...
                <i class="fa fa-info-circle"></i> {{ $errors->first('name') }}
                                ...
                                <div class="form-group row {{ $errors->has('description') ? ' text-red' : '' }}">
                                    <label for="description"
                                           class="col-sm-2 col-form-label">{{ trans('weight.description') }}</label>
                                    <div class="col-sm-10 ">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            ...
                                            <input type="text" id="description" name="description"
                                                   value="{!! old()?old('description'):$weight['description']??'' !!}"
