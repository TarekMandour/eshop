                    ...
                    <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="tab-store-order-tab" data-toggle="pill"
                               ...
                               aria-selected="false">{{ trans('store.admin.config_order') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="tab-store-customer-tab" data-toggle="pill"
                               ...
                               aria-selected="false">{{ trans('store.admin.config_customer') }}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="tab-store-captcha-tab" data-toggle="pill" href="#tab-store-captcha"
                               ...
                               aria-selected="false">{{ trans('captcha.captcha_title') }}</a>
                        </li>
                        <li class="nav-item">
