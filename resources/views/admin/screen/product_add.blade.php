                        ...
                        @foreach ($languages as $code => $language)
                            <div class="card">
                                ...
                                <textarea id="{{ $code }}__content" class="editor"
                                    ...
                                    <div class="form-group row kind  {{ $errors->has('descriptions.'.$code.'.specifications') ? ' text-red' : '' }}">
                                        <label for="{{ $code }}__specifications" class="col-sm-2 col-form-label">
                                            Specifications
                                        </label>
                                        <div class="col-sm-8">
                                <textarea id="{{ $code }}__specifications" class="editor"
                                          name="descriptions[{{ $code }}][specifications]">
                                        {!! old('descriptions.'.$code.'.specifications') !!}
                                    </textarea>
                                    ...
                                    <div class="form-group row kind  {{ $errors->has('descriptions.'.$code.'.condition') ? ' text-red' : '' }}">
                                        <label for="{{ $code }}__condition" class="col-sm-2 col-form-label">
                                            Condition
                                        </label>
                                        <div class="col-sm-8">
                                <textarea id="{{ $code }}__condition" class="editor"
                                          name="descriptions[{{ $code }}][condition]">
                                        {!! old('descriptions.'.$code.'.condition') !!}
                                    </textarea>
                                    ...
                                    <div class="form-group row kind  {{ $errors->has('descriptions.'.$code.'.delivery') ? ' text-red' : '' }}">
                                        <label for="{{ $code }}__delivery" class="col-sm-2 col-form-label">
                                            Delivery
                                        </label>
                                        <div class="col-sm-8">
                                <textarea id="{{ $code }}__delivery" class="editor"
                                          name="descriptions[{{ $code }}][delivery]">
                                        {!! old('descriptions.'.$code.'.delivery') !!}
                                    </textarea>
                                    ...
                                    <div class="form-group row kind  {{ $errors->has('descriptions.'.$code.'.warranty') ? ' text-red' : '' }}">
                                        <label for="{{ $code }}__warranty" class="col-sm-2 col-form-label">
                                            Warranty
                                        </label>
                                        <div class="col-sm-8">
                                <textarea id="{{ $code }}__warranty" class="editor"
                                          name="descriptions[{{ $code }}][warranty]">
                                        {!! old('descriptions.'.$code.'.warranty') !!}
                                    </textarea>
