            ...
            <div class="d-flex flex-column-fluid">
                            ...
                            <div class="card-title">
                                @if ($layout == 'edit')
                                    <div class="btn-group float-right" style="margin-right: 5px">
                                        <a href="{{ sc_route_admin('admin_brand.index') }}"
                ...
                <i class="fa fa-info-circle"></i> {{ $errors->first('name') }}
                                ...
                                <div class="form-group row {{ $errors->has('alias') ? ' text-red' : '' }}">
                                    <label for="alias"
                                           class="col-sm-2 col-form-label">{!! trans('brand.alias') !!}</label>
                                    <div class="col-sm-10 ">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            ...
                                            <input type="text" id="alias" name="alias"
                                                   value="{!! old()?old('alias'):$brand['alias']??'' !!}"
                                                   class="form-control alias {{ $errors->has('alias') ? ' is-invalid' : '' }}">
                                        </div>
                                    ...
                                    <div class="col-sm-10 ">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" id="url" name="url"
                                                   value="{!! old()?old('url'):$brand['url']??'' !!}"
                                                   class="form-control url {{ $errors->has('url') ? ' is-invalid' : '' }}">
                                        </div>
                                    ...
                                    <div class="col-sm-10 ">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" id="image" name="image"
                                                   value="{!! old()?old('image'):$brand['image']??'' !!}"
                ...
                <i class="fa fa-info-circle"></i> {{ $errors->first('image') }}
                                ...
                                <div class="form-group row {{ $errors->has('sort') ? ' text-red' : '' }}">
                                    <label for="sort"
                                           class="col-sm-2 col-form-label">{!! trans('brand.sort') !!}</label>
                                    <div class="col-sm-10 ">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                            ...
                                            <input type="number" id="sort" name="sort" min=0
                                                   value="{!! old()?old('sort'):$brand['sort']??0 !!}"
