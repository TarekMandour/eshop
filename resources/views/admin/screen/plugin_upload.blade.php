    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container py-8">
            <div class="card">
                ...
                <form action="{{ sc_route_admin('admin_plugin.process_import') }}" method="post" accept-charset="UTF-8"
                      class="form-horizontal" id="import-product" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
