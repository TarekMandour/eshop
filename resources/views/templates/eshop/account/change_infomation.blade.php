                        ...
                        <form method="POST" action="{{ sc_route('customer.post_change_infomation') }}">
                            ...
                            <div class="form-group {{ $errors->has('first_name') ? ' has-error' : '' }}">
                                <label for="first_name"
                                    class="col-md-4 col-form-label">{{ trans('account.first_name') }}</label>
                            ...
                            <div class="form-group {{ $errors->has('last_name') ? ' has-error' : '' }}">
                                <label for="last_name"
                                    class="col-md-4 col-form-label">{{ trans('account.last_name') }}</label>
                            ...
                            <div class="form-group {{ $errors->has('first_name') ? ' has-error' : '' }}">
                                <label for="first_name"
                                    class="col-md-4 col-form-label">{{ trans('account.name') }}</label>
                            ...
                            <div class="form-group {{ $errors->has('first_name_kana') ? ' has-error' : '' }}">
                                <label for="first_name_kana"
                                    class="col-md-4 col-form-label">{{ trans('account.first_name_kana') }}</label>
                            ...
                            <div class="form-group {{ $errors->has('last_name_kana') ? ' has-error' : '' }}">
                                <label for="last_name_kana"
                                    class="col-md-4 col-form-label">{{ trans('account.last_name_kana') }}</label>
                            ...
                            <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                                <label for="phone"
                                    class="col-md-4 col-form-label">{{ trans('account.phone') }}</label>
                            ...
                            <div class="form-group {{ $errors->has('postcode') ? ' has-error' : '' }}">
                                <label for="postcode"
                                    class="col-md-4 col-form-label">{{ trans('account.postcode') }}</label>
                            ...
                            <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                <label for="email"
                                    class="col-md-4 col-form-label">{{ trans('account.email') }}</label>
                            ...
                            <div class="form-group {{ $errors->has('address1') ? ' has-error' : '' }}">
                                <label for="address1"
                                    class="col-md-4 col-form-label">{{ trans('account.address1') }}</label>
                            ...
                            <div class="form-group {{ $errors->has('address2') ? ' has-error' : '' }}">
                                <label for="address2"
                                    class="col-md-4 col-form-label">{{ trans('account.address2') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group {{ $errors->has('address3') ? ' has-error' : '' }}">
                                <label for="address3"
                                    class="col-md-4 col-form-label">{{ trans('account.address3') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group {{ $errors->has('country') ? ' has-error' : '' }}">
                                <label for="country"
                                    class="col-md-4 col-form-label">{{ trans('account.country') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group {{ $errors->has('sex') ? ' has-error' : '' }}">
                                <label for="sex"
                                    class="col-md-4 col-form-label">{{ trans('account.sex') }}</label>
                            ...
                            <div class="form-group {{ $errors->has('birthday') ? ' has-error' : '' }}">
                                <label for="birthday"
                                    class="col-md-4 col-form-label">{{ trans('account.birthday') }}</label>
