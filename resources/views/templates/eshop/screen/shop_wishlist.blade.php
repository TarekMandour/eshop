                        ...
                        @endphp
                            <div class="tt-item">
                                <div class="tt-col-description">
                                    <div class="tt-img">
                                        <img src="{{sc_file($product->getImage())}}" alt="{{ $product->name }}">
                                    </div>
                                ...
                                <div class="tt-col-btn">
                                    ...
                                    <a class="btn-link" href="{{$product->getUrl() }}" target="_blank"><i class="icon-f-73"></i>SEE PRODUCT</a>
                                    <a onClick="return confirm('{{trans('messages.ask_delete')}}')" title="Remove Item" alt="Remove Item"
                                class="btn-link js-removeitem" href="{{ sc_route('cart.remove', ['id'=>$item->rowId, 'instance' => 'wishlist']) }}">
                                <i class="icon-h-02"></i>REMOVE </a>
                                </div>
                            </div>
                        @endforeach
                    </div>
